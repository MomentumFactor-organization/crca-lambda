...
output "boto3_layer_arn" {
  value = aws_lambda_layer_version.boto3_layer[0].arn
}

output "requests_layer_arn" {
  value = aws_lambda_layer_version.requests_layer[0].arn
}

output "psycopg2_layer_arn" {
  value = aws_lambda_layer_version.psycopg2_layer[0].arn
}
